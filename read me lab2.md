...
Conclusion:
We learnt about the use of DDA(digital differential analyzer) line algorithm. In this algorithm ,we needed to round up decimal point values
to get pixel value which would creale some round off error.